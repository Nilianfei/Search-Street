      ...
      success(res) {
        ...
        if (res.data.success) {
          ...
          for (var i = 0; i < appeal.appealImgList.length; i++) {
            ...
            that.data.imgaddr[i] = appeal.appealImgList[i].imgAddr ;
          }
          console.log(that.data.imgaddr);
          //if (appeal.appealMoreInfo != "") {
           // address = address + ' (' + appeal.appealMoreInfo + ' )';
          //}
          var region=[];
          region[0]=appeal.province;
          region[1]=appeal.city;
          region[2]=appeal.district;
          that.setData({
            helpDetail: appeal,
