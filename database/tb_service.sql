...
CREATE TABLE `tb_service`  (
  ...
  `service_price` double NOT NULL COMMENT '服务价格',
...
-- ----------------------------
INSERT INTO `tb_service` VALUES (1, 2, '测试service店铺', 12, 5, '提供各式果汁和奶茶饮品，美味点心', '饮品，甜点', '\\upload\\images\\item\\shop\\serviceImg\\1\\2019031823550876447.png');
...
INSERT INTO `tb_service` VALUES (6, 1, '茄子肉沫', 15, 4, '优质茄子经过油炸，和瘦肉精致翻炒制成', '茄子，瘦肉', NULL);
INSERT INTO `tb_service` VALUES (7, 1, '123', 21, 4, '123456', '213', NULL);
